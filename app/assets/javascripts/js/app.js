    ...
    function handleSwitcher() {    
        ...
        var setColor = function (color, data_header) {
            ...
            if(data_header == 'light'){
                jQuery('#style_color-header-1').attr("href", "/assets/themes/headers/header1-" + color + ".css");
                jQuery('#logo-header').attr("src", "/assets/logo1-" + color + ".png");
                jQuery('#logo-footer').attr("src", "/assets/logo2-" + color + ".png");
            } else if(data_header == 'dark'){
                jQuery('#style_color-header-2').attr("href", "/assets/themes/headers/header2-" + color + ".css");
                jQuery('#logo-header').attr("src", "/assets/logo1-" + color + ".png");
                jQuery('#logo-footer').attr("src", "/assets/logo2-" + color + ".png");
            }
        }
